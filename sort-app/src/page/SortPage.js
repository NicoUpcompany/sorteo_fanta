        ...
        <ConfigProvider locale={es_ES}>
            <Spin spinning={loading} size="large" tip="Cargando...">
                <Row style={{ padding: '20px' }} >
                    <Col span={24} >
                        <Title type='warning' style={{ color: "#024e1d", paddingTop: '20px', textAlign: 'center', width: '100%' }} >Sorteos Andina</Title>
                    </Col>
                    <Col span={24} >
                    ...
                    <Col span={24} >
                        <Title type='warning' style={{ color: "#024e1d", paddingTop: '20px', textAlign: 'center', width: '100%' }} >Sorteos Embonor</Title>
                    </Col>
                    <Col span={24} >
